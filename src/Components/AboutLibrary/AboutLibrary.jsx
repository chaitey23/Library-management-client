...
const AboutLibrary = () => {
    return (
        <section className=" px-4 py-16">
            <div className="flex flex-col md:flex-row items-center gap-8  shadow-2xl rounded-2xl">
                ...
                < motion.div initial={{ x: 100, opacity: 0 }}
                    ...
                    <h2 className="text-5xl font-bold mb-4 text-[#1a4137]">About the Library</h2>
                    <p className="text-gray-500 mb-4 text-[18px]">
                    ...
                    <button className="px-6 py-3 bg-[#163839] text-white font-semibold rounded-3xl  transition">
                        Explore Books
                    </button>
                </motion.div>
